...
fetch("https://seller.digikala.com/api/v2/product-creation/attributes/6946?categoryId=6946", {
  headers: {
    accept: "application/json, text/plain, */*",
    "accept-language": "en-US,en;q=0.7",
    "captcha-token": "",
    ...
    "x-web-optimize-response": "1",
    cookie:
      "_dwid=019d2687-0194-72a4-bb3b-e61a726534e7; _sentinel_dwid=019d2687-0405-7359-8469-01eb10c645f3; TS018d011a=0102310591dd44ea3327683611192a0d5d0a3b5b14c4599f77a79800f77aa3d41de7dc1935a52b1080b6d25be766ec73889683a8fd; PHPSESSID=3a83i9b823fl9rrthccqvb3c8d; _ym_uid=1700600433852661810; _ym_d=1769917371; seller_api_access_token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzM4NCJ9..VjI9PVFlLlnmX2Bk_77It1Tp3KZUnzdojbxEw6zLnp6AOmGbIbpDObvcBmtfUW7I; tracker_glob_new=dIxTRLm; tracker_glob_new=dIxTRLm; tracker_session=3MVtzcP; _sp_ses.13cb=*; _sp_id.13cb=a8719869-38ff-4a83-92e5-0dc2e3445efd.1698599848.122.1774744514.1774674892.89381f3f-a1ef-4bd9-b31c-3ef5b2ff4d98.3044f14a-1276-4f63-b2fd-983e4d0dbb70.96a047be-0a6d-42b5-be1d-babf638399ec.1774737253175.25",
    Referer: "https://seller.digikala.com/pwa/product/create/3?categoryId=6946&draftProductId=6983192",
  },
  body: null,
  method: "GET",
});
var obj = {
  ...
  data: {
      ...
      664: {
        ...
        attributes: {
          119: {
            ...
            value: null,
            values: [],
            hint: "در صورت نیاز می‌توانید توضیحاتی مختصر در مورد ویژگی‌های کالا ارائه دهید.",
          },
          4931: {
            id: 4931,
            title: "نوع کاربرد",
          ...
          10132: {
            ...
            values: {
              ...
              60281: {
                text: "روکش شاین ضد آب",
                code: null,
                selected: false,
              },
              60282: {
                text: "روکش شفاف ضد آب",
                code: null,
                selected: false,
              },
            },
    ...
    dimension_attribute_multiplier: 0,
    weight_attribute_multiplier: null,
  },
};

fetch("https://seller.digikala.com/api/v2/product-creation/draft-product/6983192?draftProductId=6983192", {
  headers: {
    accept: "application/json, text/plain, */*",
    "accept-language": "en-US,en;q=0.7",
    "captcha-token": "",
...
var obj = {
  ...
  data: {
    ...
    platforms: null,
    description:
      "خیلی عالیه این حصولات خیلی عالیه این حصولات خیلی عالیه این حصولات خیلی عالیه این حصولات خیلی عالیه این حصولات خیلی عالیه این حصولات خیلی عالیه این حصولات خیلی عالیه این حصولات خیلی عالیه این حصولات ",
    advantages: ["قوت 1"],
    disadvantages: ["ضعف 1"],
    title_en: null,
    title_fa: null,
